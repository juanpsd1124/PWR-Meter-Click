...
def SetCalibrationValues(VoltageCal, CurrentCal, PowerActCal, FreqCal):
    ...
    CalibrationFreqValArray.append( FreqCal & 0xFF)
    CalibrationFreqValArray.append( (FreqCal >> 8) & 0xFF)
...
def ReadCalibrationValues():
    ...
    try:
        ...
        buffercal = ReadFrame(Registers.Reg_Calibration_Current, 0x0C)
        time.sleep(0.1)
...
def GetValues():
  ...
  try:
    ...
    if(buffervalues[0] == 0x06 and bufferaccum[0] == 0x06 and bufferalerts[0] == 0x06):
      ...
      Measurement.CurrentRMS   = round( ( buffervalues[13] << 24 | buffervalues[12] << 16 | buffervalues[11] << 8 | buffervalues[10] ) * 0.001 , 2)
      ...
      print("Voltaje = {} V  Corriente = {} A  Potencia Activa = {} W  Potencia Reactiva = {} VAr  Potencia Aparente = {} VA  Frecuencia = {} Hz  Temperatura = {} Grados Potencia Consumida = {} W/h"
...
#SetEventsLimits("105.50","220.50","1.86","220.00")