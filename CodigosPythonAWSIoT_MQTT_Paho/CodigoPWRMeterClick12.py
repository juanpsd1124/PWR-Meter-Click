...
def GetValues():
    ...
    try:
        ...
        if(buffervalues[0] == 0x06 and bufferaccum[0] == 0x06):
            ...
            ValuesDict = { 'Voltaje':  Measurement.VoltageRMS ,
                           ...
                           'Potencia Consumida' : EnergyAccum.ImportActivePowerCounter}
            ...
            return ValuesList, EnergyAccum.ImportActivePowerCounter
...
def SumValues():
    ...
    Val,PWRAccum = GetValues()

    for i in range(0,7):
    
        ValuesSum[i].append(Val[i])

    ValuesSum[7] = PWRAccum
