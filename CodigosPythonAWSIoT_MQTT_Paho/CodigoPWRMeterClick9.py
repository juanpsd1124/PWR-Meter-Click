...
def ScanEvents():
    ...
    try:
        ...
        if(bufferevents[0] == 0x06):
            ...
            EventsDict = { 'VSag':  Events.VSagFlag , 'VSurge' : Events.VSurgeFlag , 'OverCurrent' : Events.OverCurrentFlag  , 'OverPower' : Events.OverPowerFlag , 'NoEvent': Events.NoEventFlag , 'Hour' : str(datetime.datetime.now()) }
...
ReadEventsLimits()
SetEventsLimits(500, 1200, 440000, 470000)
ReadEventsLimits()
