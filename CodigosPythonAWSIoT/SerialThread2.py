...
def SendSerial():
    ...
    #fifo_queue2.put(ser.read(n))
    
    fifo_queue2.put(recibido)
        
    #print(fifo_queue2.put(recibido))
...
hilo1 = threading.Thread(target=Thread1)
hilo2 = threading.Thread(target=Thread2)
hilo3 = threading.Thread(target=Thread3)
hilo4 = threading.Thread(target=Thread4)
